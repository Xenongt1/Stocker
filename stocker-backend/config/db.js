...
process.env.PGDATABASE = process.env.DB_NAME || 'stocker_db';
process.env.PGPASSWORD = process.env.DB_PASSWORD || 'karabum05';
process.env.PGPORT = process.env.DB_PORT || 5432;

const pool = new Pool(); // It will use the environment variables automatically
